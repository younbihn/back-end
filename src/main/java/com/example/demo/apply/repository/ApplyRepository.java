...
public interface ApplyRepository extends JpaRepository<Apply, Long> {
    ...
    Optional<List<Apply>> findAllByMatching_IdAndStatus(long matchingId, ApplyStatus applyStatus);

    Optional<Integer> countByMatching_IdAndStatus(long matchingId, ApplyStatus applyStatus);
