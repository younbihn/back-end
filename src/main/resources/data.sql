...
insert into matching (SITE_USER_ID, TITLE, CONTENT, LOCATION, DATE, START_TIME, END_TIME,  RECRUIT_NUM, COST, IS_RESERVED, NTRP, AGE, RECRUIT_STATUS, CREATE_TIME, MATCHING_TYPE, DEAD_LINE)
...
insert into matching (SITE_USER_ID, TITLE, CONTENT, LOCATION, 
                      DATE, START_TIME, END_TIME, RECRUIT_NUM, 
